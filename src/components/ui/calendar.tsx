  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: 'absolute left-1 text-muted-foreground hover:text-foreground',
        nav_button_next: 'absolute right-1 text-muted-foreground hover:text-foreground',
